...
#define SCORE_STRING_EX				TEXT("%s")							//积分类型
...
#define PRIME_SERVER				1009L								//服务数量
...
#define LEN_QQ_NUMBER_ID			13									//证件号码
...
#define GAME_GENRE_MONEY			0x000F								//真钱类型
